<template>
  <v-card
    max-width="344"
    max-height="460px"
    class="float-left ma-4 py-2 px-2"
    elevation="4"
  >
    <v-img class="ml-4 " :src="imagesUrl + pizza.image"></v-img>
    ...
    <v-card-actions>
      <div class="text-h5 px-2">
        ...
        {{
          this.$store.getters["currency/currenciesSymbol"][
      ...
      <div>
        <v-btn-toggle
          v-if="this.$store.getters['cart/cart'][pizza.id]"
          dense
          multiple
        >
